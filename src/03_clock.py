...
#     time_display: Text = Text(
#         value="00:00:00",  # Initial value
#         color=ft.Colors.CYAN_300,
#         size=60,
#         weight=ft.FontWeight.BOLD,
#     )

#     # Add the time display to the page inside a Row for centering
#     page.add(
#         Row(
#             alignment=ft.MainAxisAlignment.CENTER,  # Centers the Text control horizontally within the Row
#             controls=[
#                 time_display,
#             ],
#             # If you want the Row itself to expand and center its content, you can add:
#             # expand=True
#         )
#     )

#     # Function that will run in a separate thread to update the time
